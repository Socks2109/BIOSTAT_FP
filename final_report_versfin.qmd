...
Question of Interest: How does the different age groups of younger individuals compared to older individuals differ in the rate of mortality due to HIV/AIDS for the year 2002 and 2013?
...
HIV_TB_young_numeric_2002 <- as.numeric(as.character(HIV_TB_young_2002$mean))
HIV_TB_older_numeric_2002 <- as.numeric(as.character(HIV_TB_older_2002$mean))
HIV_TB_young_numeric_2013 <- as.numeric(as.character(HIV_TB_young_2013$mean))
HIV_TB_older_numeric_2013 <- as.numeric(as.character(HIV_TB_older_2013$mean))

# Remove any NA values
HIV_TB_young_numeric_2002 <- HIV_TB_young_numeric_2002[!is.na(HIV_TB_young_numeric_2002)]
HIV_TB_older_numeric_2002 <- HIV_TB_older_numeric_2002[!is.na(HIV_TB_older_numeric_2002)]
HIV_TB_young_numeric_2013 <- HIV_TB_young_numeric_2013[!is.na(HIV_TB_young_numeric_2013)]
HIV_TB_older_numeric_2013 <- HIV_TB_older_numeric_2013[!is.na(HIV_TB_older_numeric_2013)]
