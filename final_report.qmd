...
![](images/Replicate Graph.png){width="372"}
...
![](images/Replicate Table.png){width="600"}
...
ggplot(summary_data, aes(x = condition, y = sum_value, fill = factor(year))) +
  ...
  scale_fill_manual(values = c("2002" = "cornflowerblue", "2013" = "darkslategray1")) +  # Custom colors for each year
  labs(
